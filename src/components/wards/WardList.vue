...
import Table from "./WardTable.vue";
import Search from "./WardSearch.vue";
import WardCreateUpdate from "./WardCreateUpdate.vue";
import BaseVisibleColumn from "../base/BaseVisibleColumn.vue";
import SortColumn from "../base/SortColumn.vue";
import Modal from "../base/Modal.vue";
import useForm from "src/hooks/useForm";
import useService from "src/hooks/useService";
import { wardColumns } from "src/config/tableColumns";
    ...
    const onClick = async (action) => {
      switch (action) {
        case "Create":
          ...
          break;
        case "Update":
          selectedRow.value = wardTable.value.getCurrentRow();
        ...
        case "Search":
          ...
          break;
        case "Delete":
          deletedRow.value = wardTable.value.selected;
    ...
    const closeModal = async (payload, modalName) => {
      switch (modalName) {
        case "delete":
          ...
          await Ward.remove(deletedRow.value[0].id);
          break;
        case "add":
